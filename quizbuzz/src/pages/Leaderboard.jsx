  ...
  return (
    <div>
      ...
      <div className='container mx-auto'>
        <table className='w-full flex justify-center sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5'>
          <thead className='text-white'>
            <tr className='bg-green-400 flex flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 '>
